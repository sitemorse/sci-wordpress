...
CONTENT;
		...
		add_settings_section(
			...
			function() {
				echo '<div><p>Marked content for the Sitemorse scanner.</p>'; },
			'sitemorse_marked_section'
		);

		add_settings_section(
			'sitemorse_settings',
			'Marked Content Filters',
			function() {
				echo '<p>Add filters for Marked Content on functions:</p>'; },
		...
		$this->register_settings(
			...
			array(
				...
				'sitemorse_sci_host',
				'sitemorse_sci_port',
				'sitemorse_sci_ssl_port',
				'sitemorse_headers',
				'sitemorse_query',
				'sitemorse_page_list',
				'sitemorse_author',
				'sitemorse_demo_mode',
				'sitemorse_marked_the_excerpt',
				'sitemorse_marked_get_the_excerpt',
				'sitemorse_marked_the_content',
				'sitemorse_marked_get_the_content',
				'sitemorse_marked_the_title',
				'sitemorse_marked_post_thumbnail',
				'sitemorse_publish_permission',
				'sitemorse_test_connection',
				'sitemorse_debug_mode',
			)
		);
		...
		$this->add_settings_fields(
			array(
				...
				array(
					'sitemorse_publish_permission',
					'Allow Publishing of Pages with Issues',
				...
				array(
					...
					array(
						'id'      => 'sitemorse_demo_mode',
						'default' => 'off',
						'class'   => 'markedDisable hidden',
					),
				),
			),
			'sitemorse_settings_section'
		...
		$this->add_settings_fields(
			array(
				...
				array(
					'sitemorse_author',
					'Include author in marked content tags',
					array( $this->elem, 'checkbox_field' ),
					array(
						'id'      => 'sitemorse_author',
						'default' => 'on',
		...
		$this->add_settings_fields(
			array(
				...
				array(
					...
					array( $this->elem, 'checkbox_field' ),
					array(
						'id'      => 'sitemorse_marked_the_excerpt',
						'default' => 'on',
						'class'   => 'markedDisable',
					),
				),
				array(
					...
					array( $this->elem, 'checkbox_field' ),
					array(
						'id'      => 'sitemorse_marked_get_the_excerpt',
						'default' => 'on',
						'class'   => 'markedDisable',
					),
				),
				array(
					...
					array( $this->elem, 'checkbox_field' ),
					array(
						'id'      => 'sitemorse_marked_the_content',
						'default' => 'on',
						'class'   => 'markedDisable',
					),
				),
				array(
					...
					array( $this->elem, 'checkbox_field' ),
					array(
						'id'      => 'sitemorse_marked_get_the_content',
						'default' => 'on',
						'class'   => 'markedDisable',
					),
				),
				array(
					...
					array( $this->elem, 'checkbox_field' ),
					array(
						'id'      => 'sitemorse_marked_post_thumbnail',
						'default' => 'on',
						'class'   => 'markedDisable',
					),
				),
		...
		$this->add_settings_fields(
			array(
				...
				array(
					...
					array(
						'id'      => 'sitemorse_post',
						'desc'    => 'Allow Sitemorse server to process POST requests',
						'default' => 'off',
					),
				),
				array(
				...
				array(
					'sitemorse_sci_host',
					'Sitemorse Server Hostname',
					array( $this->elem, 'text_field' ),
					array(
						'id'      => 'sitemorse_sci_host',
						'default' => 'sci.sitemorse.com',
						'desc'    => 'Sitemorse server hostname. Normally sci.sitemorse.com',
					),
				),
				array(
					'sitemorse_sci_port',
					'Sitemorse Server Port',
					array( $this->elem, 'text_field' ),
					array(
						'id'      => 'sitemorse_sci_port',
						'default' => '5371',
						'desc'    => 'Normally 5371',
					),
				),
				array(
					'sitemorse_sci_ssl_port',
					'Sitemorse Server SSL Port',
					array( $this->elem, 'text_field' ),
					array(
						'id'      => 'sitemorse_sci_ssl_port',
						'default' => '5372',
						'desc'    => 'Normally 5372',
					),
				),
  ...
  window.location = "' . admin_url( 'admin.php?page=sitemorse_conn_test_page' ) . '";
	...
	public function add_admin_pages() {
		...
		add_menu_page(
			...
			'Sitemorse Redirect',
			'edit_pages',
			'sitemorse_redirect_page',
			'sitemorse_redirect'
		);
		add_menu_page(
			'Sitemorse Connection',
			'Sitemorse Connection',
			'administrator',
			'sitemorse_conn_test_page',
			'sitemorse_conn_test'
		);
		add_menu_page(
			'Sitemorse Results',
			'Sitemorse Results',
			'edit_pages',
			'sitemorse_latest_scan_page',
			'sitemorse_latest_scan',
		...
		add_options_page(
			...
			'Sitemorse',
			'administrator',
			'sitemorse_config_page',
			array( $this, 'sitemorse_config' )
		);
...
CONTENT;
	...
	public function publish_permission_field() {
		...
		foreach ( get_editable_roles() as $role_name => $role_info ) {
			...
			$checked = '';
			if ( array_key_exists( $role_name, $options ) ) {
				$checked = 'checked';
			}
			$op .= '<li>' .
